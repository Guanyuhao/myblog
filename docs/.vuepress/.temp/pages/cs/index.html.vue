<template><div><h1 id="网络" tabindex="-1"><a class="header-anchor" href="#网络"><span>网络</span></a></h1>
<blockquote>
<p>推荐<a href="https://yuchengkai.cn/docs/cs/" target="_blank" rel="noopener noreferrer">原文<ExternalLinkIcon/></a></p>
</blockquote>
<h1 id="udp" tabindex="-1"><a class="header-anchor" href="#udp"><span>UDP</span></a></h1>
<h2 id="面向报文" tabindex="-1"><a class="header-anchor" href="#面向报文"><span>面向报文</span></a></h2>
<p>UDP 是一个面向报文（报文可以理解为一段段的数据）的协议。意思就是 UDP 只是报文的搬运工，不会对报文进行任何拆分和拼接操作。</p>
<p>具体来说</p>
<ul>
<li>在发送端，应用层将数据传递给传输层的 UDP 协议，UDP 只会给数据增加一个 UDP 头标识下是 UDP 协议，然后就传递给网络层了</li>
<li>在接收端，网络层将数据传递给传输层，UDP 只去除 IP 报文头就传递给应用层，不会任何拼接操作</li>
</ul>
<h2 id="不可靠性" tabindex="-1"><a class="header-anchor" href="#不可靠性"><span>不可靠性</span></a></h2>
<ol>
...
<h2 id="高效" tabindex="-1"><a class="header-anchor" href="#高效"><span>高效</span></a></h2>
<p>因为 UDP 没有 TCP 那么复杂，需要保证数据不丢失且有序到达。所以 UDP 的头部开销小，只有八字节，相比 TCP 的至少二十字节要少得多，在传输数据报文时是很高效的。</p>
<p><img src="https://yck-1254263422.cos.ap-shanghai.myqcloud.com/blog/2019-06-01-42633.png" alt=""></p>
<p>头部包含了以下几个数据</p>
<ul>
...
<h2 id="传输方式" tabindex="-1"><a class="header-anchor" href="#传输方式"><span>传输方式</span></a></h2>
<p>UDP 不止支持一对一的传输方式，同样支持一对多，多对多，多对一的方式，也就是说 UDP 提供了单播，多播，广播的功能。</p>
<h1 id="tcp" tabindex="-1"><a class="header-anchor" href="#tcp"><span>TCP</span></a></h1>
<h2 id="头部" tabindex="-1"><a class="header-anchor" href="#头部"><span>头部</span></a></h2>
<p>TCP 头部比 UDP 头部复杂的多</p>
<p><img src="https://yck-1254263422.cos.ap-shanghai.myqcloud.com/blog/2019-06-01-042634.png" alt=""></p>
...
<li>SYN=1：当 SYN=1，ACK=0 时，表示当前报文段是一个连接请求报文。当 SYN=1，ACK=1 时，表示当前报文段是一个同意建立连接的应答报文。</li>
<li>FIN=1：该字段为一表示此报文段是一个释放连接的请求报文。</li>
</ul>
</li>
</ul>
<h2 id="状态机" tabindex="-1"><a class="header-anchor" href="#状态机"><span>状态机</span></a></h2>
<p>HTTP 是无连接的，所以作为下层的 TCP 协议也是无连接的，虽然看似 TCP 将两端连接了起来，但是其实只是两端共同维护了一个状态</p>
<p><img src="https://yck-1254263422.cos.ap-shanghai.myqcloud.com/blog/2019-06-01-042638.png" alt=""></p>
<p>TCP 的状态机是很复杂的，并且与建立断开连接时的握手息息相关，接下来就来详细描述下两种握手。</p>
<p>在这之前需要了解一个重要的性能指标 RTT。该指标表示发送端发送数据到接收到对端数据所需的往返时间。</p>
<h3 id="建立连接三次握手" tabindex="-1"><a class="header-anchor" href="#建立连接三次握手"><span>建立连接三次握手</span></a></h3>
<p><img src="https://yck-1254263422.cos.ap-shanghai.myqcloud.com/blog/2019-06-01-042641.png" alt=""></p>
...
<p>客户端向服务端发送连接请求报文段。该报文段中包含自身的数据通讯初始序号。请求发送后，客户端便进入 SYN-SENT 状态，<code v-pre>x</code> 表示客户端的数据通信初始序号。</p>
...
<h3 id="断开链接四次握手" tabindex="-1"><a class="header-anchor" href="#断开链接四次握手"><span>断开链接四次握手</span></a></h3>
<p><img src="https://yck-1254263422.cos.ap-shanghai.myqcloud.com/blog/2019-06-01-42642.png" alt=""></p>
...
<h2 id="arq-协议" tabindex="-1"><a class="header-anchor" href="#arq-协议"><span>ARQ 协议</span></a></h2>
<p>ARQ 协议也就是超时重传机制。通过确认和超时机制保证了数据的正确送达，ARQ 协议包含停止等待 ARQ 和连续 ARQ</p>
<h3 id="停止等待-arq" tabindex="-1"><a class="header-anchor" href="#停止等待-arq"><span>停止等待 ARQ</span></a></h3>
...
<h3 id="连续-arq" tabindex="-1"><a class="header-anchor" href="#连续-arq"><span>连续 ARQ</span></a></h3>
<p>在连续 ARQ 中，发送端拥有一个发送窗口，可以在没有收到应答的情况下持续发送窗口内的数据，这样相比停止等待 ARQ 协议来说减少了等待时间，提高了效率。</p>
<h3 id="累计确认" tabindex="-1"><a class="header-anchor" href="#累计确认"><span>累计确认</span></a></h3>
<p>连续 ARQ 中，接收端会持续不断收到报文。如果和停止等待 ARQ 中接收一个报文就发送一个应答一样，就太浪费资源了。通过累计确认，可以在收到多个报文以后统一回复一个应答报文。报文中的 ACK 可以用来告诉发送端这个序号之前的数据已经全部接收到了，下次请发送这个序号 + 1 的数据。</p>
...
<p>在上面小节中讲到了发送窗口。在 TCP 中，两端都维护着窗口：分别为发送端窗口和接收端窗口。</p>
<p>发送端窗口包含已发送但未收到应答的数据和可以发送但是未发送的数据。</p>
<p><img src="https://yck-1254263422.cos.ap-shanghai.myqcloud.com/blog/2019-06-01-042642.png" alt=""></p>
<p>发送端窗口是由接收窗口剩余大小决定的。接收方会把当前接收窗口的剩余大小写入应答报文，发送端收到应答后根据该值和当前网络拥塞情况设置发送窗口的大小，所以发送窗口的大小是不断变化的。</p>
<p>当发送端接收到应答报文后，会随之将窗口进行滑动</p>
<p><img src="https://yck-1254263422.cos.ap-shanghai.myqcloud.com/blog/2019-06-01-042643.png" alt=""></p>
<p>滑动窗口实现了流量控制。接收方通过报文告知发送方还可以发送多少数据，从而保证接收方能够来得及接收数据。</p>
<h3 id="zero-窗口" tabindex="-1"><a class="header-anchor" href="#zero-窗口"><span>Zero 窗口</span></a></h3>
<p>在发送报文的过程中，可能会遇到对端出现零窗口的情况。在该情况下，发送端会停止发送数据，并启动 persistent timer 。该定时器会定时发送请求给对端，让对端告知窗口大小。在重试次数超过一定次数后，可能会中断 TCP 链接。</p>
<h2 id="拥塞处理" tabindex="-1"><a class="header-anchor" href="#拥塞处理"><span>拥塞处理</span></a></h2>
<p>拥塞处理和流量控制不同，后者是作用于接收方，保证接收方来得及接受数据。而前者是作用于网络，防止过多的数据拥塞网络，避免出现网络负载过大的情况。</p>
<p>拥塞处理包括了四个算法，分别为：慢开始，拥塞避免，快速重传，快速恢复。</p>
<h3 id="慢开始算法" tabindex="-1"><a class="header-anchor" href="#慢开始算法"><span>慢开始算法</span></a></h3>
...
<h3 id="拥塞避免算法" tabindex="-1"><a class="header-anchor" href="#拥塞避免算法"><span>拥塞避免算法</span></a></h3>
...
<h3 id="快速重传" tabindex="-1"><a class="header-anchor" href="#快速重传"><span>快速重传</span></a></h3>
...
<h3 id="tcp-new-ren-改进后的快恢复" tabindex="-1"><a class="header-anchor" href="#tcp-new-ren-改进后的快恢复"><span>TCP New Ren 改进后的快恢复</span></a></h3>
...
<p>HTTP 协议是个无状态协议，不会保存状态。</p>
<h2 id="post-和-get-的区别" tabindex="-1"><a class="header-anchor" href="#post-和-get-的区别"><span>Post 和 Get 的区别</span></a></h2>
<p>先引入副作用和幂等的概念。</p>
...
<li>Post 相对 Get 安全一点点，因为 Get 请求都包含在 URL 里，且会被浏览器保存历史纪录，Post 不会，但是在抓包的情况下都是一样的。</li>
<li>Post 可以通过 request body 来传输比 Get 更多的数据，Get 没有这个技术</li>
...
<h2 id="http-首部" tabindex="-1"><a class="header-anchor" href="#http-首部"><span>HTTP 首部</span></a></h2>
<table>
<thead>
<tr>
...
<td style="text-align:center">浏览器想要优先使用的连接类型，比如 <code v-pre>keep-alive</code></td>
</tr>
<tr>
...
<thead>
<tr>
<th style="text-align:center">实体字段</th>
<th style="text-align:center">作用</th>
</tr>
</thead>
<tbody>
...
<td style="text-align:center">Base64 加密格式的内容 MD5 检验值</td>
</tr>
<tr>
...
<p>PS：缓存相关已在别的模块中写完，你可以 <RouteLink to="/Performance/performance-ch.html#%E7%BC%93%E5%AD%98">阅读该小节</RouteLink></p>
<h1 id="https" tabindex="-1"><a class="header-anchor" href="#https"><span>HTTPS</span></a></h1>
<p>HTTPS 还是通过了 HTTP 来传输信息，但是信息通过 TLS 协议进行了加密。</p>
<h2 id="tls" tabindex="-1"><a class="header-anchor" href="#tls"><span>TLS</span></a></h2>
...
<p><img src="https://yck-1254263422.cos.ap-shanghai.myqcloud.com/blog/2019-06-01-042644.jpg" alt=""></p>
<ol>
...
<h1 id="http-2-0" tabindex="-1"><a class="header-anchor" href="#http-2-0"><span>HTTP 2.0</span></a></h1>
...
<p>你可以通过 <a href="https://http2.akamai.com/demo" target="_blank" rel="noopener noreferrer">该链接<ExternalLinkIcon/></a> 感受下 HTTP 2.0 比 HTTP 1.X 到底快了多少。</p>
<p><img src="https://yck-1254263422.cos.ap-shanghai.myqcloud.com/blog/2019-06-01-042644.png" alt=""></p>
<p>在 HTTP 1.X 中，因为队头阻塞的原因，你会发现请求是这样的</p>
<p><img src="https://yck-1254263422.cos.ap-shanghai.myqcloud.com/blog/2019-06-01-042646.png" alt=""></p>
<p>在 HTTP 2.0 中，因为引入了多路复用，你会发现请求是这样的</p>
<p><img src="https://yck-1254263422.cos.ap-shanghai.myqcloud.com/blog/2019-06-01-042647.png" alt=""></p>
<h2 id="二进制传输" tabindex="-1"><a class="header-anchor" href="#二进制传输"><span>二进制传输</span></a></h2>
<p>HTTP 2.0 中所有加强性能的核心点在于此。在之前的 HTTP 版本中，我们是通过文本的方式传输数据。在 HTTP 2.0 中引入了新的编码机制，所有传输的数据都会被分割，并采用二进制格式编码。</p>
<p><img src="https://yck-1254263422.cos.ap-shanghai.myqcloud.com/blog/2019-06-01-042649.png" alt=""></p>
...
<p><img src="https://yck-1254263422.cos.ap-shanghai.myqcloud.com/blog/2019-06-01-042650.png" alt=""></p>
<h2 id="header-压缩" tabindex="-1"><a class="header-anchor" href="#header-压缩"><span>Header 压缩</span></a></h2>
...
<h2 id="服务端-push" tabindex="-1"><a class="header-anchor" href="#服务端-push"><span>服务端 Push</span></a></h2>
...
<h2 id="quic" tabindex="-1"><a class="header-anchor" href="#quic"><span>QUIC</span></a></h2>
<p>这是一个谷歌出品的基于 UDP 实现的同为传输层的协议，目标很远大，希望替代 TCP 协议。</p>
<ul>
...
<li>支持重传和纠错机制（向前恢复），在只丢失一个包的情况下不需要重传，使用纠错机制恢复丢失的包
<ul>
...
<h1 id="dns" tabindex="-1"><a class="header-anchor" href="#dns"><span>DNS</span></a></h1>
...
<li>如果这时候还没得话，会直接去 DNS 根服务器查询，这一步查询会找出负责 <code v-pre>com</code> 这个一级域名的服务器</li>
<li>然后去该服务器查询 <code v-pre>google</code> 这个二级域名</li>
<li>接下来三级域名的查询其实是我们配置的，你可以给 <code v-pre>www</code> 这个域名配置一个 IP，然后还可以给别的三级域名配置一个 IP</li>
</ol>
<p>以上介绍的是 DNS 迭代查询，还有种是递归查询，区别就是前者是由客户端去做请求，后者是由系统配置的 DNS 服务器做请求，得到结果后将数据返回给客户端。</p>
<p>PS：DNS 是基于 UDP 做的查询。</p>
<h1 id="从输入-url-到页面加载完成的过程" tabindex="-1"><a class="header-anchor" href="#从输入-url-到页面加载完成的过程"><span>从输入 URL 到页面加载完成的过程</span></a></h1>
...
<li>文件解码成功后会正式开始渲染流程，先会根据 HTML 构建 DOM 树，有 CSS 的话会去构建 CSSOM 树。如果遇到 <code v-pre>script</code> 标签的话，会判断是否存在 <code v-pre>async</code> 或者 <code v-pre>defer</code> ，前者会并行进行下载并执行 JS，后者会先下载文件，然后等待 HTML 解析完成后顺序执行，如果以上都没有，就会阻塞住渲染流程直到 JS 执行完毕。遇到文件下载的会去下载文件，这里如果使用 HTTP 2.0 协议的话会极大的提高多图的下载效率。</li>
<li>初始的 HTML 被完全加载和解析后会触发 <code v-pre>DOMContentLoaded</code> 事件</li>
